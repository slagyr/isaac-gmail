  ...
  (let [headers (payload-headers raw)
    ...
    (compact
      {:id         (or (:id raw) (get raw "id"))
       ...
       :precedence (or (:precedence raw) (header headers "Precedence"))
       :auto-submitted (or (:auto-submitted raw) (header headers "Auto-Submitted"))
       :list-unsubscribe (or (:list-unsubscribe raw) (header headers "List-Unsubscribe"))
