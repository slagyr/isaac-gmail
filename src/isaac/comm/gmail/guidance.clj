...
(def TEXT
  (str "Your response is the text you end this turn with. It is delivered back over the channel "
       ...
       "response, so still end the turn with it, even if it is short. Files people attach are saved under attachments/ in your working directory and listed with the message; read them with the file tools. You cannot view images yet — say so if asked what an image shows."))
